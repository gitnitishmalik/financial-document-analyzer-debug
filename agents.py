...
# Initialize the LLM with increased timeout for heavy processing
llm = LLM(
    model="ollama/llama3",
...
financial_analyst = Agent(
    ...
    llm=llm,
    max_iter=3,  # FIX: Increased to 3 so it can: 1. Use Tool, 2. Analyze, 3. Respond
    max_rpm=10,
...
# Investment Advisor / Fund Salesperson Agent
